...
function generateMentionsOverTime(competitorId: string): MentionPoint[] {
...
export const competitorsData: CompetitorData[] = [
  {
    ...
    trendingComplaints: ['Slow performance', 'Expensive', 'Poor customer support'],
    mentionsOverTime: generateMentionsOverTime('1'),
  ...
  },
  {
    ...
    trendingComplaints: ['Buggy interface', 'Limited features', 'Confusing pricing'],
    mentionsOverTime: generateMentionsOverTime('2'),
    alternativesMentioned: [
  ...
  },
  {
    ...
    mentionsOverTime: generateMentionsOverTime('3'),
    alternativesMentioned: [
  ...
  },
  {
    ...
    trendingComplaints: ['API changes', 'Complex setup', 'Inadequate documentation'],
    mentionsOverTime: generateMentionsOverTime('4'),
    alternativesMentioned: [
...
export const commentsData: Comment[] = [
  {
    ...
    platform: 'Reddit',
    username: 'user123',
    content: 'Their product is so slow, I can\'t believe I\'m paying for this. It takes forever to load basic features.',
  ...
  },
  {
    ...
    platform: 'Twitter',
    username: 'tech_user',
    content: 'Just canceled my CompetitorX subscription. The customer support is non-existent and there are too many bugs.',
    date: randomDate(new Date(Date.now() - 90 * 24 * 60 * 60 * 1000), new Date()),
    sentiment: 0.15,
  ...
  },
  {
    ...
    content: 'Great features but way too expensive for what you get. Looking for alternatives that offer better value.',
    date: randomDate(new Date(Date.now() - 90 * 24 * 60 * 60 * 1000), new Date()),
    sentiment: 0.4,
  ...
  },
  {
    ...
    platform: 'Reddit',
    username: 'dev_expert',
    content: 'SoftCorp has a very confusing interface. It took our team weeks to figure out basic workflows.',
    date: randomDate(new Date(Date.now() - 90 * 24 * 60 * 60 * 1000), new Date()),
    sentiment: 0.3,
  ...
  },
  {
    ...
    content: 'We\'re migrating away from SoftCorp because of their new pricing model. It\'s ridiculously expensive for startups.',
    date: randomDate(new Date(Date.now() - 90 * 24 * 60 * 60 * 1000), new Date()),
    sentiment: 0.25,
  ...
  },
  {
    ...
    content: 'TechGiant recently had a major outage that affected our business for days. Their support was unresponsive.',
    date: randomDate(new Date(Date.now() - 90 * 24 * 60 * 60 * 1000), new Date()),
    sentiment: 0.1,
  ...
  },
  {
    ...
    content: 'Concerned about TechGiant\'s data practices. They\'ve had multiple breaches this year and haven\'t been transparent.',
    date: randomDate(new Date(Date.now() - 90 * 24 * 60 * 60 * 1000), new Date()),
    sentiment: 0.2,
  ...
  },
  {
    ...
    content: 'CloudSystems documentation is so lacking. Spent hours trying to integrate with their API.',
    date: randomDate(new Date(Date.now() - 90 * 24 * 60 * 60 * 1000), new Date()),
    sentiment: 0.35,
...
export const leadsData: Lead[] = [
  {
    ...
    content: 'Looking for alternatives to CompetitorX. Their performance issues are killing our productivity. Any recommendations?',
    issue: 'Performance',
    date: randomDate(new Date(Date.now() - 60 * 24 * 60 * 60 * 1000), new Date()),
    status: 'new',
  ...
  },
  {
    ...
    content: 'CompetitorX just raised prices by 30%. Anyone using a more affordable alternative with similar features?',
    issue: 'Pricing',
    date: randomDate(new Date(Date.now() - 60 * 24 * 60 * 60 * 1000), new Date()),
    status: 'contacted',
  ...
  },
  {
    ...
    content: 'After 2 years with SoftCorp, we\'re looking to switch. Their support has gone downhill and the product is buggy.',
    issue: 'Support',
    date: randomDate(new Date(Date.now() - 60 * 24 * 60 * 60 * 1000), new Date()),
    status: 'new',
  ...
  },
  {
    ...
    content: 'TechGiant\'s latest update broke our entire workflow. Looking for recommendations on similar tools with better stability.',
    issue: 'Reliability',
    date: randomDate(new Date(Date.now() - 60 * 24 * 60 * 60 * 1000), new Date()),
    status: 'responded',
  ...
  },
  {
    ...
    content: 'Done with CloudSystems. Their API changes without notice, and docs are always out of date. What are others using?',
    issue: 'Documentation',
    date: randomDate(new Date(Date.now() - 60 * 24 * 60 * 60 * 1000), new Date()),
    status: 'new',
